...
export function drawCircle(
    svg,
    { cx = 0, cy = 0, r = 0, fill = "black", id = null },
) {
...
export function drawRectangle(
    svg,
    { x = 0, y = 0, width = 0, height = 0, fill = "black" },
) {
...
export function drawTriangle(
    svg,
    { x1 = 0, y1 = 0, x2 = 0, y2 = 0, x3 = 0, y3 = 0, fill = "black" },
) {
...
export function drawText(svg, { x = 0, y = 0, text = "" }) {
...
export function drawExample(svg) {
